...
target 'PolyvLiveScenesDemo' do
  ...
  # 保利威 多场景 SDK
  pod 'PLVLiveScenesSDK', '1.18.0'

  # 保利威 手机开播场景 需依赖的库
  pod 'PLVBytedEffectSDK', '4.4.2'
  pod 'PLVBusinessSDK', '1.18.0', :subspecs => ['Beauty']
...
target 'PLVScreenShareExtension' do
  use_frameworks!
  pod 'PLVBusinessSDK', '1.18.0', :subspecs => ['AbstractBSH','ReplayKitExt']
  pod 'PLVFoundationSDK', '1.17.1', :subspecs => ['AbstractBase']
end
