...
/// RTC在线用户模型 针对 LiveStreamerScene手机开播场景 的UI扩展
@interface PLVLinkMicOnlineUser (LS)
...
@property (nonatomic, strong) PLVLSLinkMicCanvasView * canvasView;
