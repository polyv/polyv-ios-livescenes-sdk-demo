...
#pragma mark - Block
//撤销操作的回调
@property (nonatomic, copy) PLVHCAlertViewBlock cancelBlock;
//确认操作的回调
@property (nonatomic, copy) PLVHCAlertViewBlock confirmBlock;

@end


@implementation PLVHCAlertView
...
+ (instancetype)alertViewWithTitle:(NSString * _Nullable)title
    ...
    PLVHCAlertView *alertView = [[PLVHCAlertView alloc] init];
