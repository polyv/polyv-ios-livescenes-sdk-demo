//
//  PLVECRealTimeSubtitleLanguageSelectView.m
//  PolyvLiveScenesDemo
//
...
@interface PLVECRealTimeSubtitleLanguageSelectView () <UITableViewDataSource, UITableViewDelegate>
...
@implementation PLVECRealTimeSubtitleLanguageSelectView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIdentifier = @"PLVECRealTimeSubtitleLanguageSelectCell";
