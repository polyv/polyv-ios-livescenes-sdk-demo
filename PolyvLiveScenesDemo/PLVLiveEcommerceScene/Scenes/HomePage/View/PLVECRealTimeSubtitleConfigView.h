//
//  PLVECRealTimeSubtitleConfigView.h
//  PolyvLiveScenesDemo
//
...
@protocol PLVECRealTimeSubtitleConfigViewDelegate <NSObject>
...
@interface PLVECRealTimeSubtitleConfigView : PLVECBottomSheet

@property (nonatomic, weak) id<PLVECRealTimeSubtitleConfigViewDelegate> delegate;
