//
//  PLVECWelfareLotteryWidgetView.m
//  PolyvLiveScenesDemo
//
...
@interface PLVECWelfareLotteryWidgetView ()
...
@implementation PLVECWelfareLotteryWidgetView
...
- (void)updateWelfareLotteryWidgetInfo:(NSDictionary *)dict {
    ...
    if ([PLVFdUtil checkStringUseable:iconUrl]) {
        ...
        UIImage *image = [PLVECUtils imageForWatchResource:PLVLocalizedString(@"plvec_chatroom_welfare_lottery_widget_icon")];
