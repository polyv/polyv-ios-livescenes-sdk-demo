//
//  PLVECRealTimeSubtitleConfigView.m
//  PolyvLiveScenesDemo
//
...
#import "PLVECRealTimeSubtitleLanguageSelectView.h"
...
@interface PLVECRealTimeSubtitleConfigView ()
...
@property (nonatomic, strong) PLVECRealTimeSubtitleLanguageSelectView *languageSelectView; // 语言选择视图

@end

@implementation PLVECRealTimeSubtitleConfigView
...
- (void)languageRowTapped:(UITapGestureRecognizer *)gesture {
    ...
    if (!self.languageSelectView) {
        self.languageSelectView = [[PLVECRealTimeSubtitleLanguageSelectView alloc] init];
