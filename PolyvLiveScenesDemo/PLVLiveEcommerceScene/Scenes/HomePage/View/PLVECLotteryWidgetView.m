...
@interface PLVECLotteryWidgetView ()
...
@implementation PLVECLotteryWidgetView
...
- (void)updateLotteryWidgetInfo:(NSDictionary *)dict {
    ...
    if ([eventName isEqualToString:@"CLICK_LOTTERY_PENDANT"]) {
        ...
        if ([PLVFdUtil checkStringUseable:iconUrl]) {
            ...
            UIImage *image = [PLVECUtils imageForWatchResource:PLVLocalizedString(@"plvec_chatroom_lottery_widget_icon")];
