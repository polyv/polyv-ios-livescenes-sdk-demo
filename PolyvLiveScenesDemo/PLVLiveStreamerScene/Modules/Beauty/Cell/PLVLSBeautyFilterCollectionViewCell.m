//
//  PLVLSBeautyFilterCollectionViewCell.m
//  PolyvLiveScenesDemo
//
...
#import "PLVLSUtils.h"
// UI
#import "PLVLSBeautyMaskView.h"
// 模块
#import "PLVLSBeautyCellModel.h"
// 依赖库
#import <PLVFoundationSDK/PLVFoundationSDK.h>

@interface PLVLSBeautyFilterCollectionViewCell()

#pragma mark UI
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) PLVLSBeautyMaskView *beautyMaskView;
...
@implementation PLVLSBeautyFilterCollectionViewCell
...
- (void)updateCellModel:(PLVLSBeautyCellModel *)cellModel beautyOpen:(BOOL)beautyOpen {
    ...
    self.imageView.image = [PLVLSUtils imageForBeautyResource:cellModel.imageName];
...
- (PLVLSBeautyMaskView *)beautyMaskView {
    if (!_beautyMaskView) {
        _beautyMaskView = [[PLVLSBeautyMaskView alloc] init];
