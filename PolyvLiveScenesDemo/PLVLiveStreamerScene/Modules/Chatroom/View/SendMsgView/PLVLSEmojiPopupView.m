...
static CGFloat PLVLSEmojiPopupViewArrowRoundRadius = 4.f;//箭头的圆角
static CGFloat PLVLSEmojiPopupViewArrowHeight_R = 12.f;//带圆角箭头的高
static CGFloat PLVLSEmojiPopupViewArrowHeight = 10.f;//不带圆角箭头的高
static CGFloat PLVLSEmojiPopupViewArrowWidth_R = 12.f;//带圆角箭头的宽
static CGFloat PLVLSEmojiPopupViewArrowWidth  = 10.f;//不带圆角箭头的宽
static CGFloat PLVLSEmojiPopupViewSizeWidth = 80;//长按弹出层视图宽

@interface PLVLSEmojiPopupView ()
...
@implementation PLVLSEmojiPopupView
...
- (UIImageView *)imageView {
    if (!_imageView) {
        ...
        _imageView.frame = CGRectMake(2, 2, PLVLSEmojiPopupViewSizeWidth - 4, PLVLSEmojiPopupViewSizeWidth - 4);
    }
    return _imageView;
}
- (UIView *)mainView {
    if (!_mainView) {
        ...
        _mainView.bounds = CGRectMake(0, 0, PLVLSEmojiPopupViewSizeWidth, PLVLSEmojiPopupViewSizeWidth + 10);
    }
    return _mainView;
}
...
- (void)setImageEmotion:(PLVImageEmotion *)imageEmotion {
    [PLVLSUtils setImageView:self.imageView url:[NSURL URLWithString:imageEmotion.url] placeholderImage:nil options:SDWebImageRetryFailed];
}
...
- (void)drawBackgroundLayerWithAnglePoint:(CGPoint)anglePoint addView:(UIView *)addView {
    ...
    CGFloat arrowHeight = _allowRoundedArrow ? PLVLSEmojiPopupViewArrowHeight_R : PLVLSEmojiPopupViewArrowHeight;
    CGFloat arrowWidth = _allowRoundedArrow ? PLVLSEmojiPopupViewArrowWidth_R : PLVLSEmojiPopupViewArrowWidth;
    UIBezierPath *path = [UIBezierPath bezierPath];
    BOOL allowRoundedArrow = _allowRoundedArrow;
    CGFloat offset = 2.f*PLVLSEmojiPopupViewArrowRoundRadius*sinf(M_PI_4/2.f);
    CGFloat roundcenterHeight = offset + PLVLSEmojiPopupViewArrowRoundRadius*sqrtf(2.f);
    ...
    if (allowRoundedArrow) {
        [path addArcWithCenter:CGPointMake(anglePoint.x + arrowWidth, anglePoint.y - arrowHeight + 2.f*PLVLSEmojiPopupViewArrowRoundRadius) radius:2.f*PLVLSEmojiPopupViewArrowRoundRadius startAngle:M_PI_2*3 endAngle:M_PI_4*5.f clockwise:NO];
        [path addLineToPoint:CGPointMake(anglePoint.x + PLVLSEmojiPopupViewArrowRoundRadius/sqrtf(2.f), roundcenterPoint.y + PLVLSEmojiPopupViewArrowRoundRadius/sqrtf(2.f))];
        [path addArcWithCenter:roundcenterPoint radius:PLVLSEmojiPopupViewArrowRoundRadius startAngle:M_PI_4 endAngle:M_PI_4*3.f clockwise:YES];
        ...
        [path addArcWithCenter:CGPointMake(anglePoint.x - arrowWidth, anglePoint.y - arrowHeight + 2.f*PLVLSEmojiPopupViewArrowRoundRadius) radius:2.f*PLVLSEmojiPopupViewArrowRoundRadius startAngle:M_PI_4*7 endAngle:M_PI_2*3 clockwise:NO];
    } else {
