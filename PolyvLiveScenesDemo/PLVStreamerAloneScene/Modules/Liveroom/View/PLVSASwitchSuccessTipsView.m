...
@interface PLVSASwitchSuccessTipsView ()
...
@implementation PLVSASwitchSuccessTipsView
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.layer.cornerRadius = kPLVSASwitchSuccessTipsViewHeight / 2.0;
