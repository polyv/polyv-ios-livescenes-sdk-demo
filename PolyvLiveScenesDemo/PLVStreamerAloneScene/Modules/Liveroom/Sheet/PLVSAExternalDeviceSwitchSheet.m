//
//  PLVSAExternalDeviceSwitchSheet.m
//  PolyvLiveScenesDemo
//
...
@interface PLVSAExternalDeviceSwitchButton : UIView
...
@implementation PLVSAExternalDeviceSwitchButton
...
@interface PLVSAExternalDeviceSwitchSheet()

@property (nonatomic, strong) UILabel *sheetTitleLabel; // 弹层顶部标题
@property (nonatomic, strong) UILabel *sheetDetailLabel;// 弹层详细信息
@property (nonatomic, strong) PLVSAExternalDeviceSwitchButton *openButton; // 开启按钮
@property (nonatomic, strong) PLVSAExternalDeviceSwitchButton *closeButton; // 关闭按钮

@end

@implementation PLVSAExternalDeviceSwitchSheet
...
- (PLVSAExternalDeviceSwitchButton *)openButton {
    if (!_openButton) {
        _openButton = [[PLVSAExternalDeviceSwitchButton alloc] initWithExternalDeviceEnabled:YES];
...
- (PLVSAExternalDeviceSwitchButton *)closeButton {
    if (!_closeButton) {
        _closeButton = [[PLVSAExternalDeviceSwitchButton alloc] initWithExternalDeviceEnabled:NO];
        __weak typeof(self) weakSelf = self;
