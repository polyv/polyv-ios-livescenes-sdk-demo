...
@interface PLVSASendMessageTextView ()
...
@implementation PLVSASendMessageTextView
...
- (void)paste:(id)sender {
    ...
    if (string.length) {
        ...
        if (newLength > PLVSASendMessageMaxTextLength) {
            processString = [string substringToIndex:string.length - (newLength - PLVSASendMessageMaxTextLength)];
        }
