...
@implementation PLVSASliderView
...
- (void)drawLine:(CGContextRef)context {
    ...
    // 画左边滑动条
    [self drawCGLine:context rect:CGRectMake(0, 0, _currentX + offset - radius / 2 - padding, _height) color:_activeLineColor];
    
    // 画右边滑动条
    [self drawCGLine:context rect:CGRectMake(_currentX + offset  + padding + radius / 2, 0, _width, _height) color:_inactiveLineColor];
}
