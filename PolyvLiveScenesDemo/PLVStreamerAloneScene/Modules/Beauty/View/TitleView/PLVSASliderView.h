...
@class PLVSASliderView;
@protocol PLVSASliderViewDelegate <NSObject>
...
/// 自定义SliderView
@interface PLVSASliderView : UIView
/// 代理
@property (nonatomic, weak) id<PLVSASliderViewDelegate> delegate;
