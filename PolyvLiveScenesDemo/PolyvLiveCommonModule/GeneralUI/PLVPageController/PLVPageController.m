...
@implementation PLVPageController
...
- (UICollectionView *)titleCollectionView {
    if (!_titleCollectionView) {
        ...
        [_titleCollectionView registerClass:[PLVPageViewCell class] forCellWithReuseIdentifier:kTitleCellIdentifier];
    }
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    PLVPageViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kTitleCellIdentifier forIndexPath:indexPath];
...
-(void)collectionView:(UICollectionView *)collectionView didDeselectItemAtIndexPath:(NSIndexPath *)indexPath {
    PLVPageViewCell *cell = (PLVPageViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
    [cell setClicked:NO];
}
...
-(void)selecteAtIndex:(NSUInteger)index {
    ...
    PLVPageViewCell *cell = (PLVPageViewCell *)[self.titleCollectionView cellForItemAtIndexPath:selectedIndexPath];
    [cell setClicked:YES];
}
...
-(void)deselectAtIndex:(NSUInteger)index {
    ...
    PLVPageViewCell *cell = (PLVPageViewCell *)[self.titleCollectionView cellForItemAtIndexPath:deselectedPath];
    [cell setClicked:NO];
}
