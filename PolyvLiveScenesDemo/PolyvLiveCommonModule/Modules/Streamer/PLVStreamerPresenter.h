...
///  prepareSuccess: 准备操作是否成功
/// @note granted == NO 时 prepareSuccess 一定为 NO，granted == YES 时 prepareSuccess 不一定为 YES
- (void)prepareLocalPreviewCompletion:(nullable void (^)(BOOL granted, BOOL prepareSuccess))completion;
