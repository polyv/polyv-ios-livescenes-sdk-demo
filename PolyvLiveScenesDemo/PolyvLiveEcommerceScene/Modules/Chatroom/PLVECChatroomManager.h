...
/*
 PLVECChatroomManager的协议
 */
@protocol PLVECChatroomManagerProtocol <NSObject>
...
/*
 ...
 2. 管理common层返回的消息模型
 3. 提供包括欢迎语逻辑等其他scene层所需要的回调（暂未完成）
 */
@interface PLVECChatroomManager : NSObject

@property (nonatomic, weak) id<PLVECChatroomManagerProtocol> delegate;
