...
@interface PLVECChatroomManager ()<
...
@implementation PLVECChatroomManager {
    /// 操作数组的信号量，防止多线程读写数组
...
+ (instancetype)sharedManager {
    ...
    static PLVECChatroomManager *mananger = nil;
...
- (void)loadHistory {
    self.presenter.eachLoadingHistoryCount = 10;
