...
@implementation PLVLiveScenesSubtitleItem
...
- (NSString *)description {
    return [NSString stringWithFormat:@"%02f --> %02f : %@",
            PLVLiveScenesSubtitleTimeGetSeconds(self.startTime),
            PLVLiveScenesSubtitleTimeGetSeconds(self.endTime),
            self.text];
}
