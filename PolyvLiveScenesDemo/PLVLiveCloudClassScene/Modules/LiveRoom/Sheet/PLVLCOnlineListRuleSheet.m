//
//  PLVLCOnlineListRuleSheet.m
//  PolyvLiveScenesDemo
//
//  Created by Dhan on 2024/9/4.
...
@interface PLVLCOnlineListRuleSheet ()
...
@implementation PLVLCOnlineListRuleSheet
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        [_closeButton setImage:[PLVLCUtils imageForMediaResource:@"plvlc_online_list_rule_close"] forState:UIControlStateNormal];
