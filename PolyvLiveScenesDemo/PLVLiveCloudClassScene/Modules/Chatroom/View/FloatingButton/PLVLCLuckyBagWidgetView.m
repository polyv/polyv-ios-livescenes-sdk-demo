...
#import "PLVLCLuckyBagWidgetView.h"
...
@interface PLVLCLuckyBagWidgetView ()
...
@implementation PLVLCLuckyBagWidgetView
...
- (void)layoutSubviews {
    ...
    if (!fullScreen) {
        ...
        self.iconImageView.frame = CGRectMake(0, 0, CGRectGetWidth(self.bounds), CGRectGetWidth(self.bounds));
...
- (void)updateLuckyBagWidgetInfo:(NSDictionary *)dict {
    ...
    if ([PLVFdUtil checkStringUseable:iconUrl]) {
        ...
        UIImage *image = [PLVLCUtils imageForChatroomResource:PLVLocalizedString(@"plvlc_chatroom_lucky_bag_widget_icon")];
