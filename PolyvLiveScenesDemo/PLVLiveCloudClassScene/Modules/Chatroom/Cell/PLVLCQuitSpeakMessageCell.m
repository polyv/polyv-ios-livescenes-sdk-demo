...
@interface PLVLCQuitSpeakMessageCell ()
...
@implementation PLVLCQuitSpeakMessageCell
...
- (void)updateWithModel:(PLVChatModel *)model loginUserId:(NSString *)loginUserId cellWidth:(CGFloat)cellWidth {
    ...
    if (self.cellWidth == 0 || ![PLVLCQuitSpeakMessageCell isModelValid:model]) {
        self.cellWidth = 0;
        return;
    }
    
    NSMutableAttributedString *contentLabelString = [PLVLCQuitSpeakMessageCell contentLabelAttributedStringWithMessage:model.message
                                                                                                              user:model.user];
...
+ (CGFloat)cellHeightWithModel:(PLVChatModel *)model cellWidth:(CGFloat)cellWidth {
    ...
    if (cellHeight == 0 || ![PLVLCQuitSpeakMessageCell isModelValid:model]) {
        return 0;
    }
