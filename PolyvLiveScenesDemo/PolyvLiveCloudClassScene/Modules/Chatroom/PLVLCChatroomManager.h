...
/*
 PLVLCChatroomManager的协议
 允许设置多个监听者
 */
@protocol PLVLCChatroomManagerProtocol <NSObject>
 ...
 */
@interface PLVLCChatroomManager : NSObject
...
/// 增加PLVChatroomPresenterProtocol协议的监听者
/// @param listener 待增加的监听者
- (void)addListener:(id<PLVLCChatroomManagerProtocol>)listener;

/// 移除PLVChatroomPresenterProtocol协议的监听者
/// @param listener 待移除的监听者
- (void)removeListener:(id<PLVLCChatroomManagerProtocol>)listener;

/// 移除PLVChatroomPresenterProtocol协议的所有监听者
