...
- (void)viewDidLoad {
    ...
    [[PLVLCChatroomManager sharedManager] createAnswerChatModel];
}
...
- (void)keyboardToolView:(PLVKeyboardToolView *)toolView sendText:(NSString *)text {
    BOOL success = [[PLVLCChatroomManager sharedManager] sendQuesstionMessage:text];
    if (!success) {
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [[PLVLCChatroomManager sharedManager].privateChatArray count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PLVChatModel *model = [[PLVLCChatroomManager sharedManager].privateChatArray objectAtIndex:indexPath.row];
